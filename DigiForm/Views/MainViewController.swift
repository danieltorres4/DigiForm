...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // CONSTRAINTS
        var gridValue = (view.bounds.width) / 5 // ancho pantalla / 5
        NSLayoutConstraint.activate([
            ...
            // BUTTONS
            fillFormButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: gridValue),
            fillFormButton.topAnchor.constraint(equalTo: mainIV.bottomAnchor, constant: 20),
            showSavedDataButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -gridValue),
            ...
            fillFormButton.trailingAnchor.constraint(equalTo: showSavedDataButton.leadingAnchor, constant: -gridValue)
        ])
    }
}
